...
class BootstrapRequestMap {
    ...
    public BootstrapRequest get(String cacheName) {
        ...
        if (bootstrapRequest == null) {
            LOG.info("BootstrapRequest for " + cacheName + " has been GCed, removing from requests map.");
    ...
    public void cleanBootstrapRequests() {
        for (final Iterator<Map.Entry<String, Reference<BootstrapRequest>>> bootstrapRequestItr = 
            ...
            if (bootstrapRequestEntry.getValue().get() == null) {
                LOG.info("BootstrapRequest for " + bootstrapRequestEntry.getKey() + " has been GCed, removing from requests map.");
