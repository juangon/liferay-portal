			...
			<div class="body-row">
				...
				<c:if test="<%= PropsValues.DL_FILE_ENTRY_PREVIEW_ENABLED %>">
					<div>
						...
						<%
						String previewId = PortalUtil.generateRandomKey(request, "portlet_document_library_view_file_entry_preview_previewId");
							...
							<c:otherwise>
								<c:choose>
									...
									<c:when test="<%= hasImages %>">
										<div class="lfr-preview-file lfr-preview-image" id="<portlet:namespace /><%= previewId %>previewFile">
											<div class="lfr-preview-file-content lfr-preview-image-content" id="<portlet:namespace /><%= previewId %>previewFileContent">
										...
										<div class="lfr-preview-file lfr-preview-video" id="<portlet:namespace /><%= previewId %>previewFile">
											<div class="lfr-preview-file-content lfr-preview-video-content">
												<div class="lfr-preview-file-video-current-column">
													<div id="<portlet:namespace /><%= previewId %>previewFileContent"></div>
												</div>
											</div>
										</div>
									...
									<c:otherwise>
										<div class="lfr-preview-file" id="<portlet:namespace /><%= previewId %>previewFile">
											<div class="lfr-preview-file-content" id="<portlet:namespace /><%= previewId %>previewFileContent">
												<div class="lfr-preview-file-image-current-column">
													<div class="lfr-preview-file-image-container">
														<img class="lfr-preview-file-image-current" id="<portlet:namespace /><%= previewId %>previewFileImage" src="<%= previewFileURL + "1" %>" />
													</div>
													<span class="lfr-preview-file-actions hide" id="<portlet:namespace /><%= previewId %>previewFileActions">
														<span class="lfr-preview-file-toolbar" id="<portlet:namespace /><%= previewId %>previewToolbar"></span>

														<span class="lfr-preview-file-info">
															<span class="lfr-preview-file-index" id="<portlet:namespace /><%= previewId %>previewFileIndex">1</span> <liferay-ui:message key="of" /> <span class="lfr-preview-file-count"><%= previewFileCount %></span>
														</span>
													</span>
												</div>

												<div class="lfr-preview-file-images" id="<portlet:namespace /><%= previewId %>previewImagesContent">
										...
										<aui:script use="liferay-preview">
											new Liferay.Preview(
												{
													actionContent: '#<portlet:namespace /><%= previewId %>previewFileActions',
													baseImageURL: '<%= previewFileURL %>',
													boundingBox: '#<portlet:namespace /><%= previewId %>previewFile',
													contentBox: '#<portlet:namespace /><%= previewId %>previewFileContent',
													currentPreviewImage: '#<portlet:namespace /><%= previewId %>previewFileImage',
													imageListContent: '#<portlet:namespace /><%= previewId %>previewImagesContent',
													maxIndex: <%= previewFileCount %>,
													previewFileIndexNode: '#<portlet:namespace /><%= previewId %>previewFileIndex',
													toolbar: '#<portlet:namespace /><%= previewId %>previewToolbar'
												}
											).render();
										</aui:script>
									</c:otherwise>
